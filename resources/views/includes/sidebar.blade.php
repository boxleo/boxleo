    ...
    <div class="sidebar-inner slimscroll">
        <div id="sidebar-menu" class="sidebar-menu">
            ...
            <ul>
                ...
                <li class="submenu">
                    <a href="javascript:void(0);" data-toggle="collapse" data-target="#recruitment">
                        <i class="la la-users"></i>
                        <span>Recruitment</span>
                        <span class="menu-arrow"></span>
                    </a>
                    <ul id="recruitment" class="collapse">
                        <li><a href="/recruitment/dashboard">Recruitment Dashboard</a></li>
                        <li><a href="/recruitment/jobs">Jobs</a></li>
                        <li><a href="/recruitment/applications">Applications</a></li>
                        <li><a href="/recruitment/applicants">Candidates</a></li>
                    </ul>
                </li>
